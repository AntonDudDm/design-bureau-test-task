function postprocess(t, X, R, outdir, P)
  ...
  plot_xyz_figure(6, t, r_sc, "SC position vector components (ECI J2000)", ...
                  {"x, m", "y, m", "z, m"}, ...
                  {"SC r_x(t)", "SC r_y(t)", "SC r_z(t)"});

  plot_xyz_figure(7, t, v_sc, "SC velocity vector components (ECI J2000)", ...
                  {"v_x, m/s", "v_y, m/s", "v_z, m/s"}, ...
                  {"SC v_x(t)", "SC v_y(t)", "SC v_z(t)"});

  plot_xyz_figure(8, t, r_lv, "LV stage position vector components (ECI J2000)", ...
                  {"x, m", "y, m", "z, m"}, ...
                  {"LV r_x(t)", "LV r_y(t)", "LV r_z(t)"});

  plot_xyz_figure(9, t, v_lv, "LV stage velocity vector components (ECI J2000)", ...
                  {"v_x, m/s", "v_y, m/s", "v_z, m/s"}, ...
  ...
  set(gcf, "Name", "Relative trajectory", "NumberTitle", "off");
  ...
  if nargin >= 4 && ~isempty(outdir)
    try
      saveas(2, fullfile(outdir, "traj3d.png"));
      saveas(3, fullfile(outdir, "distance.png"));
      saveas(4, fullfile(outdir, "vrel.png"));
      saveas(5, fullfile(outdir, "force.png"));

      saveas(6, fullfile(outdir, "sc_position_xyz.png"));
      saveas(7, fullfile(outdir, "sc_velocity_xyz.png"));
      saveas(8, fullfile(outdir, "lv_position_xyz.png"));
      saveas(9, fullfile(outdir, "lv_velocity_xyz.png"));

      saveas(10,  fullfile(outdir, "relative_traj_sc_wrt_lv.png"));
      saveas(11, fullfile(outdir, "traj_center_of_mass_frame.png"));
    catch
